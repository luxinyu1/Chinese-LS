...
MIX_RES_PATH = './data/mix_output.csv'
...
mix_res = read_generate_result(mix_res_path)
...
valid_mix_res = substitute_selection(mix_res, word_list, origin_words)
...
save_results(valid_mix_res, './data/mix_ss_res.csv')